...
class _ReportDetailsScreenState extends State<ReportDetailsScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: buildInfoField('المكان والموقع', location)),
              SizedBox(width: 16),
              Expanded(child: buildInfoField('اللون', color)),
            ],
          ),
          SizedBox(height: 15),
          Row(
            children: [
              Expanded(child: buildInfoField('التاريخ والوقت', dateTime)),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: buildInfoField('اسم الطالب', studentName)),
              SizedBox(width: 16),
              Expanded(child: buildInfoField('الرقم الجامعي', studentId)),
            ],
          ),
          SizedBox(height: 15),
          Row(
            children: [
              Expanded(
                  child: buildInfoField('البريد الإلكتروني', studentEmail)),
            ],
          ),
        ],
      ),
  ...
  Widget buildFoundButton() {
    return Center(
      child: ElevatedButton(
        onPressed: () {
          // هنا بتحط الإجراء اللي بدك تعمله لما يضغط المستخدم "تم العثور"
        },
