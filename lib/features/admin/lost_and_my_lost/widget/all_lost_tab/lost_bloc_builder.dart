...
import 'package:iug_finder/features/admin/lost_and_my_lost/widget/all_lost_tab/lost_reports_list_view.dart';
...
class LostBlocBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AllLostAndFoundCubit, AllLostAndFoundState>(
